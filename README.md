...
|fiscal_group_number                         |Integer            |Податкова група товара. Визначає, за якою податковою групою має реєструватися товар у фіскальному реєстраторі (ФР). Відповідає індексу групи у ФР. Наприклад, у ФР існують такі групи: А, Б, В, Г, М. Відповідність груп та значень:<br><table><tbody><tr><th>Група</th><th>fiscal_group_number</th><th>Група в картці товара в ТЦУ</th></tr><tr><td>А (20%)</td><td>0</td><td>(1) 20.00%</td></tr></tbody></table>><br>Залежно від типу реєстратора, індекс груп вище 4-ї (Група Г) слід визначати практично. Важливо використовувати реєстратори одного типу та з однаково встановленими значеннями податкових ставок на всіх торгових точках, які працюють із єдиним довідником товарів.|
